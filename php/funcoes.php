...
function criarLista(){
    $listaNoticia[0] = array(
        ...
        "href" => "https://localhost/infOlympic/index.php?pagina=medina"
    );
    $listaNoticia[1] = array(
        ...
        "href" => "https://localhost/infOlympic/index.php?pagina=rayssa"
    );
    $listaNoticia[2] = array(
        ...
        "href" => "https://localhost/infOlympic/index.php?pagina=rebeca"
    );
    $listaNoticia[3] = array(
        ...
        "href" => "https://localhost/infOlympic/index.php?pagina=beatriz"
    );
    $listaNoticia[4] = array(
        ...
        "href" => "https://localhost/infOlympic/index.php?pagina=julia"
    );
    $listaNoticia[5] = array(
        ...
        "href" => "https://localhost/infOlympic/index.php?pagina=flavia"
    );
    return $listaNoticia;
};
